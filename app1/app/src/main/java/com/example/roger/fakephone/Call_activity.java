...
public class Call_activity extends AppCompatActivity {
    ...
    HashMap<String, Character> buttonIDStoVal=new HashMap<String, Character>();
    ...
    public void butonPress(View v){
        ...
        char value=buttonIDStoVal.get(id);
        phoneNumber.setText(phoneNumber.getText().toString()+value);
    }
